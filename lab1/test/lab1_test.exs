defmodule Lab1Test do
  ...
  # @tag :skip
  test "task 5: find_min" do
    assert Lab1.find_min([5]) == 5
    assert Lab1.find_min([1, 2, 3]) == 1
    assert Lab1.find_min([3, 2, 1]) == 1
    assert Lab1.find_min([2, 1, 3]) == 1
    assert Lab1.find_min([1, -1, 0]) == -1
  end
